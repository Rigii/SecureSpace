export const styles = {
  ...
  bronzeText: 'self-center font-medium text-base text-[#CE8946]',
  lightButtonText: 'self-center font-medium text-base text-white',
  filled: 'mr-0 text-white bg-[#CE8946]', // TODO: #CE8946 to the theme color system
  light: 'mr-0 text-gray-500 bg-white',
  lightBordered: 'mr-0 text-[#CE8946] bg-white border-[1px] border-[#CE8946]',
